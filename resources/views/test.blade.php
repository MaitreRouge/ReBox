        ...
        <form class="mt-6">
            ...
            <div class="mt-4">
                <div class="flex items-center justify-between">
                    ...
                    <a href="forgot-password" class="text-xs text-gray-600 dark:text-gray-400 hover:underline">Forget Password?</a>
                </div>
...
{{--        </div>--}}
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-400"> Don't have an account?
            <a href="register"class="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create One</a>
        </p>
    </div>
</div>
</html>
